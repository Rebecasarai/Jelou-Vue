    ...
    <div class="container">
     ...
     <footer class="text-center" id="footerId">
        {{ new Date().getFullYear() }}
          <strong>Jelou&copy;</strong> —
          <a href="https://github.com/Rebecasarai/Jelou-Vue" strong style="color: black; text-align: center;"><h6>Enlace a repositorio de Github <i class="fab fa-github"></i></h6></a>
          <a href="#" v-if="isAutenticado" v-on:click="cerrarSesion" class="ml-2">Cerrar Sesion</a>
      </footer>
...
export default {
  ...
  methods: {
    ...
    cerrarSesion(){
      ...
      Vue.logOut();
      console.log("Cierra session "+ Vue.getToken);
      this.$router.push("/");
      this.$router.go()
    }
  },
